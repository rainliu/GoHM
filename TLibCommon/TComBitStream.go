...
func (this *TComInputBitstream) Read            ( uiNumberOfBits uint, ruiBits *uint )(err error){
  ...
  case 3: aligned_word  = this.ReadByte() << 24; fallthrough
  case 2: aligned_word |= this.ReadByte() << 16; fallthrough
  case 1: aligned_word |= this.ReadByte() <<  8; fallthrough
  case 0: aligned_word |= this.ReadByte();
  }
